...
```{r Conectando ao git e ao github, eval=FALSE, include=FALSE}
...
```{r Instalando pacote basesCursosR, eval=FALSE, include=FALSE}
...
```{r Salvar bancos de dados, eval=FALSE, include=FALSE}
...
```{r Pergunta 5, letra C, echo=TRUE}
...
Eu tinha `r minha_idade` quando o filme "Hair" foi lançado.
...
grafico_avaliacoes_idade <- notas %>%
  ...
  scale_fill_discrete() +
  ylim(0, 10) +
  labs(title = "Figura 1 - Médias das notas dadas ao filme \"Hair\" por faixa etária",
